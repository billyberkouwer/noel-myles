...
void main() {
  ...
  mvPosition = modelViewMatrix * vec4( position.x, position.y, position.z, 1.0 );
  mvPosition.x = mod(mvPosition.x, size) - size;
  mvPosition.y = mod(mvPosition.y, size) - size;
  mvPosition.z = mod(mvPosition.z, size) - size;
